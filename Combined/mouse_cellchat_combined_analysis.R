...
cellchat_mouse_young <-  readRDS("C:/Users/annub/Downloads/Aging/mouse/cellchat_mouse_young.rds")
cellchat_mouse_old <- readRDS("C:/Users/annub/Downloads/Aging/mouse/cellchat_mouse_old.rds")

object.list <- list(MY = cellchat_mouse_young, MO =  cellchat_mouse_old )
